...
* [Structuring heterogeneous OKF bundles](heterogeneous-bundle-authoring.md) - All five registered roots, developer-knowledge as a handbook, public patterns, directory names, and init/profile limitations. Plan: [heterogeneous authoring](/plans/okmate/heterogeneous-bundle-authoring.md).
...
* [Knowledge-bundle modelling in OKMate versus okf-gem](bundle-modelling.md) - Type-first work archive versus domain-first product map; adopt Overview, Constraint-versus-Decision, `resource`, and isolate hygiene. Pairwise tools: [serradura-okf](serradura-okf.md).
* [OKMate feature gaps versus the OKF tool ecosystem](okf-tool-gaps.md) - August 2026 survey of OKF CLIs, MCP, editors; MCP/lint/SARIF/init/BM25 gaps versus review-shell strengths. Workflow synthesis: [OKF tools and workflows](/research/okf/okf-tools-and-workflows.md). Plan: [init-bundle](/plans/okmate/init-bundle.md).
* [OKMate and the agent knowledge-management landscape](agent-dev-landscape.md) - Compiled wikis, DeepWiki, Basic Memory, Letta MemFS, Glean/Rovo, llms.txt; niche adoption as a reviewable knowledge layer.
