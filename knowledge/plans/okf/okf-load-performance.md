...
**Exit:** Headless debug `run knowledge/plans/rocci/ungram-ast.md --profile-report json`
...
**2026-08-19 skip:** Release first-open `run knowledge/plans/okf/okf-load-performance.md`
